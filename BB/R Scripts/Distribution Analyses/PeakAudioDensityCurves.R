##Brave Buddies Stacked Density Plots-Peak Audio Levels
...
filenames <- list.files(path = "/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Brave Buddies Audio Level Exports/Peak Distributions", pattern = "*monday.csv", full.names = FALSE)
...
#plot density plots
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak full day composite.png",width=1000, height=600) #Opens a PNG file#
mon <- ggplot(monday_totals, aes(Full.Day, fill = ursi)) + geom_density(alpha = 0.2)
mon + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Full Day")
dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak warm up composite.png",width=1000, height=600) #Opens a PNG file#
monWU <- ggplot(monday_totals, aes(Warm.Up, fill = ursi)) + geom_density(alpha = 0.2)
monWU + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Warm Up")
dev.off()
#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak morning meeting composite.png",width=1000, height=600) #Opens a PNG file#

monMM <- ggplot(monday_totals, aes(Morning.Meeting, fill = ursi)) + geom_density(alpha = 0.2)
monMM + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Morning Meeting")
dev.off()
#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak lunch composite.png",width=1000, height=600) #Opens a PNG file#

monL <- ggplot(monday_totals, aes(Lunch, fill = ursi)) + geom_density(alpha = 0.2)
monL + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Lunch")
dev.off()
#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak outside play composite.png",width=1000, height=600) #Opens a PNG file#

monOP <- ggplot(monday_totals, aes(Outside.Play, fill = ursi)) + geom_density(alpha = 0.2)
monOP + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Outside Play")
dev.off()

#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/monday peak prize store composite.png",width=1000, height=600) #Opens a PNG file#
monPS <- ggplot(monday_totals, aes(Prize.Store, fill = ursi)) + geom_density(alpha = 0.2)
monPS + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Monday-Prize Store")
dev.off()

##Tuesday
tuesnames <- list.files(path = "/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Brave Buddies Audio Level Exports/Peak Distributions", pattern = "*tuesday", full.names = FALSE)
...
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday Peak full day composite.png",width=1000, height=600) #Opens a PNG file#

tues <- ggplot(tuesday_totals, aes(Full.Day, fill = ursi)) + geom_density(alpha = 0.2)
tues + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density on Tuesday")
dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday peak warm up composite.png",width=1000, height=600) #Opens a PNG file#
tuesdayWU <- ggplot(tuesday_totals, aes(Warm.Up, fill = ursi)) + geom_density(alpha = 0.2)
tuesdayWU + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on tuesday-Warm Up")
dev.off()
#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday peak morning meeting composite.png",width=1000, height=600) #Opens a PNG file#

tuesMM <- ggplot(tuesday_totals, aes(Morning.Meeting, fill = ursi)) + geom_density(alpha = 0.2)
tuesMM + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on tuesday-Morning Meeting")
dev.off()
#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday peak lunch composite.png",width=1000, height=600) #Opens a PNG file#

tuesL <- ggplot(tuesday_totals, aes(Lunch, fill = ursi)) + geom_density(alpha = 0.2)
tuesL + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on tuesday-Lunch")
dev.off()
#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday peak outside play composite.png",width=1000, height=600) #Opens a PNG file#

tuesOP <- ggplot(tuesday_totals, aes(Outside.Play, fill = ursi)) + geom_density(alpha = 0.2)
tuesOP + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on tuesday-Outside Play")
dev.off()

#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/tuesday peak prize store composite.png",width=1000, height=600) #Opens a PNG file#
tuesPS <- ggplot(tuesday_totals, aes(Prize.Store, fill = ursi)) + geom_density(alpha = 0.2)
tuesPS + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on tuesday-Prize Store")
dev.off()

##Wednesday
wedsnames <- list.files(path = "/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Brave Buddies Audio Level Exports/Peak Distributions", pattern = "*wednesday", full.names = FALSE)
...
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/wednesday Peak full day composite.png",width=1000, height=600) #Opens a PNG file#

wed <- ggplot(wednesday_totals, aes(Full.Day, fill = ursi)) + geom_density(alpha = 0.2)
wed + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday")

dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Wednesday peak warm up composite.png",width=1000, height=600) #Opens a PNG file#
WednesdayWU <- ggplot(wednesday_totals, aes(Warm.Up, fill = ursi)) + geom_density(alpha = 0.2)
WednesdayWU + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday-Warm Up")
dev.off()

#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Wednesday peak morning meeting composite.png",width=1000, height=600) #Opens a PNG file#

WedMM <- ggplot(wednesday_totals, aes(Morning.Meeting, fill = ursi)) + geom_density(alpha = 0.2)
WedMM + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday-Morning Meeting")
dev.off()
#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Wednesday peak lunch composite.png",width=1000, height=600) #Opens a PNG file#

WedL <- ggplot(wednesday_totals, aes(Lunch, fill = ursi)) + geom_density(alpha = 0.2)
WedL + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday-Lunch")
dev.off()
#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Wednesday peak outside play composite.png",width=1000, height=600) #Opens a PNG file#

WedOP <- ggplot(wednesday_totals, aes(Outside.Play, fill = ursi)) + geom_density(alpha = 0.2)
WedOP + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday-Outside Play")
dev.off()

#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Wednesday peak prize store composite.png",width=1000, height=600) #Opens a PNG file#
WedPS <- ggplot(wednesday_totals, aes(Prize.Store, fill = ursi)) + geom_density(alpha = 0.2)
WedPS + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Wednesday-Prize Store")
dev.off()


##Thursday

thursnames <- list.files(path = "/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Brave Buddies Audio Level Exports/Peak Distributions", pattern = "*thursday", full.names = FALSE)
...
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday Peak full day composite.png",width=1000, height=600) #Opens a PNG file#

thurs <- ggplot(thursday_totals, aes(Full.Day, fill = ursi)) + geom_density(alpha = 0.2)
thurs + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on Thursday")
dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday peak warm up composite.png",width=1000, height=600) #Opens a PNG file#
thursdayWU <- ggplot(thursday_totals, aes(Warm.Up, fill = ursi)) + geom_density(alpha = 0.2)
thursdayWU + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on thursday-Warm Up")
dev.off()

#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday peak morning meeting composite.png",width=1000, height=600) #Opens a PNG file#

thursMM <- ggplot(thursday_totals, aes(Morning.Meeting, fill = ursi)) + geom_density(alpha = 0.2)
thursMM + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on thursday-Morning Meeting")
dev.off()
#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday peak lunch composite.png",width=1000, height=600) #Opens a PNG file#

thursL <- ggplot(thursday_totals, aes(Lunch, fill = ursi)) + geom_density(alpha = 0.2)
thursL + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on thursday-Lunch")
dev.off()
#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday peak outside play composite.png",width=1000, height=600) #Opens a PNG file#

thursOP <- ggplot(thursday_totals, aes(Outside.Play, fill = ursi)) + geom_density(alpha = 0.2)
thursOP + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on thursday-Outside Play")
dev.off()

#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/thursday peak prize store composite.png",width=1000, height=600) #Opens a PNG file#
thursPS <- ggplot(thursday_totals, aes(Prize.Store, fill = ursi)) + geom_density(alpha = 0.2)
thursPS + scale_x_continuous(limits = c(65, 90), name = "Peak Child Segment dB SPL") + ggtitle("Peak dB SPL Density on thursday-Prize Store")
dev.off()


####Averages####
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Full day Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
composite + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Full Day")

dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Warm Up Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
compositeWU + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Warm Up")
dev.off()
#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Morning Meeting Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
compositeMM + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Morning Meeting")
dev.off()
#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Lunch Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
compositeL + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Lunch")
dev.off()
#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Outside Play Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
compositeOP + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Outside Play")
dev.off()
#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Prize Store Peak composite.png",width=1000, height=600) #Opens a PNG file#
...
compositePS + scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("dB SPL Density Throughout the Week-Prize Store")
dev.off()

##DENSITY PLOTS WITH CONFIDENCE INTERVALS

#monday average
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/monday Peak confidence int.png",width=800, height=600) #Opens a PNG file#
...
confcomboM <- m + geom_area(data = subset(mdf.dens, x >= mq5 & x <= mq95), 
              aes(x=x,y=y), fill = 'red', alpha = 0.1) +
  geom_vline(xintercept = mmeanx, show.legend = TRUE) +
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday")
confcomboM
dev.off()

#tuesday
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/tuesday Peak confidence int.png",width=800, height=600) #Opens a PNG file#
...
confcomboT <- t + geom_area(data = subset(tdf.dens, x >= tq5 & x <= tq95), 
              aes(x=x,y=y), fill = 'blue', alpha = 0.1) +
  geom_vline(xintercept = tmeanx, show.legend = TRUE) +
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Tuesday")
confcomboT
dev.off()

#wednesday
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/wednesday Peak confidence int.png",width=800, height=600) #Opens a PNG file#
...
confcomboW <- w + geom_area(data = subset(wdf.dens, x >= wq5 & x <= wq95), 
              aes(x=x,y=y), fill = 'purple', alpha = 0.1) +
  geom_vline(xintercept = wmeanx, show.legend = TRUE) +
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Wednesday")
confcomboW
dev.off()
#Thursday
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/thursday Peak confidence int.png",width=800, height=600) #Opens a PNG file#
...
confcomboR <- r + geom_area(data = subset(rdf.dens, x >= rq5 & x <= rq95), 
              aes(x=x,y=y), fill = 'green', alpha = 0.1) +
  geom_vline(xintercept = rmeanx, show.legend = TRUE) + 
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Thursday")
confcomboR
dev.off()

#Week Long Stacked

png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/week long stacked.png",width=800, height=600) #Opens a PNG file#

library(grid)
grid.newpage()
grid.draw(rbind(ggplotGrob(confcomboM), ggplotGrob(confcomboT), ggplotGrob(confcomboW), ggplotGrob(confcomboR), size = "last"))
dev.off()
...
MeWU <- mWU + geom_area(data = subset(mWUdf.dens, x >= mWUq5 & x <= mWUq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday Warm Up")
...
MeMM <- mMM + geom_area(data = subset(mMMdf.dens, x >= mMMq5 & x <= mMMq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday Morning Meeting")
...
MeL <- mL + geom_area(data = subset(mLdf.dens, x >= mLq5 & x <= mLq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday Lunch")
...
MeOP <- mOP + geom_area(data = subset(mOPdf.dens, x >= mOPq5 & x <= mOPq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday Outside Play")
...
MePS <- mPS + geom_area(data = subset(mPSdf.dens, x >= mPSq5 & x <= mPSq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Monday Prize Store")

#Stacked Graphs
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/Monday Events stacked.png",width=800, height=600) #Opens a PNG file#
...
TeWU <- tWU + geom_area(data = subset(tWUdf.dens, x >= tWUq5 & x <= tWUq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("tuesday Warm Up")
...
TeMM <- tMM + geom_area(data = subset(tMMdf.dens, x >= tMMq5 & x <= tMMq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("tuesday Morning Meeting")
...
TeL <- tL + geom_area(data = subset(tLdf.dens, x >= tLq5 & x <= tLq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("tuesday Lunch")
...
TeOP <- tOP + geom_area(data = subset(tOPdf.dens, x >= tOPq5 & x <= tOPq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("tuesday Outside Play")
...
TePS <- tPS + geom_area(data = subset(tPSdf.dens, x >= tPSq5 & x <= tPSq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("tuesday Prize Store")

#Stacked Graphs
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/tuesday Events stacked.png",width=800, height=600) #Opens a PNG file#
...
WeWU <- wWU + geom_area(data = subset(wWUdf.dens, x >= wWUq5 & x <= wWUq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("Wednesday Warm Up")
...
WeMM <- wMM + geom_area(data = subset(wMMdf.dens, x >= wMMq5 & x <= wMMq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("wednesday Morning Meeting")
...
WeL <- wL + geom_area(data = subset(wLdf.dens, x >= wLq5 & x <= wLq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("wednesday Lunch")
...
WeOP <- wOP + geom_area(data = subset(wOPdf.dens, x >= wOPq5 & x <= wOPq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("wednesday Outside Play")
...
WePS <- wPS + geom_area(data = subset(wPSdf.dens, x >= wPSq5 & x <= wPSq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("wednesday Prize Store")

#Stacked Graphs
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/Wednesday Events stacked.png",width=800, height=600) #Opens a PNG file#
...
ReWU <- rWU + geom_area(data = subset(rWUdf.dens, x >= rWUq5 & x <= rWUq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("thursday Warm Up")
...
ReMM <- rMM + geom_area(data = subset(rMMdf.dens, x >= rMMq5 & x <= rMMq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("thursday Morning Meeting")
...
ReL <- rL + geom_area(data = subset(rLdf.dens, x >= rLq5 & x <= rLq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("thursday Lunch")
...
ReOP <- rOP + geom_area(data = subset(rOPdf.dens, x >= rOPq5 & x <= rOPq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("thursday Outside Play")
...
RePS <- rPS + geom_area(data = subset(rPSdf.dens, x >= rPSq5 & x <= rPSq95), 
  ...
  scale_x_continuous(limits = c(75, 90), name = "Peak Child Segment dB SPL") + ggtitle("thursday Prize Store")

#Stacked Graphs
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Density Plots/Graphs with confidence intervals and mean/Peak/thursday Events stacked.png",width=800, height=600) #Opens a PNG file#
...
##BOXPLOTS##
#Full Day
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Total peak audio boxplot.png",width=800, height=600) #Opens a PNG file#

anovadata <- read.csv("/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Brave Buddies Audio Level Exports/Peak Distributions/Totals.csv")
boxplot(anovadata, main = "Vocalization Peak dB SPL vs Day", xlab = "Day", ylab = "Vocalization Peak dB SPL", varwidth = TRUE)
legend(x=1, y= 68, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()

#Warm Up
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Warm Up peak audio boxplot.png",width=800, height=600) #Opens a PNG file#
...
boxplot(wuanovadata, main = "Vocalization Peak dB SPL vs Day-Warm Up", xlab = "Day", ylab = "Vocalization Peak dB SPL")
legend(x=1, y= 75, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()

#Morning Meeting
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Morning Meeting peak audio boxplot.png",width=800, height=600) #Opens a PNG file#
...
boxplot(mmanovadata, main = "Vocalization Peak dB SPL vs Day-Morning Meeting", xlab = "Day", ylab = "Vocalization Peak dB SPL")
legend(x=1, y= 75, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()

#Lunch
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Lunch peak audio boxplot.png",width=800, height=600) #Opens a PNG file#
...
boxplot(Lanovadata, main = "Vocalization Peak dB SPL vs Day-Lunch", xlab = "Day", ylab = "Vocalization Peak dB SPL")
legend(x=1, y= 75, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()

#Outside Play
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Outside Play peak audio boxplot.png",width=800, height=600) #Opens a PNG file#
...
boxplot(OPanovadata, main = "Vocalization Peak dB SPL vs Day-Outside Play", xlab = "Day", ylab = "Vocalization Peak dB SPL")
legend(x=1, y= 72, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()

#Prize Store
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Prize Store peak audio boxplot.png",width=800, height=600) #Opens a PNG file#
...
boxplot(psanovadata, main = "Vocalization Peak dB SPL vs Day-Prize Store", xlab = "Day", ylab = "Vocalization Peak dB SPL")
legend(x=1, y= 78, c("Median", "first and third quartiles"), lty=c(1,1), lwd = c(3,1) , text.font = 8, bty = "n", cex = 1)
dev.off()
...
anovadata <- as.matrix(anovadata)
myModel=lm(anovadata~1)
analysis <- Anova(myModel, idata = groupFrame, idesign = ~groupFactors)
summary(analysis)

#Just Mon and thurs
anovadata <- as.data.frame(anovadata)
anovadata$Tuesday <- NULL
anovadata$Wednesday <- NULL
myLevels= c(1,2)
groupFactors=as.factor(myLevels)
groupFrame <- data.frame(groupFactors)
anovadata <- as.matrix(anovadata)
