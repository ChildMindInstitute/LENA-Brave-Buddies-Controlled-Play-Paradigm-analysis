#LENA Data Analysis: Warm up data
#Jacob Stroud
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/child-voc-WarmUp.png",width=1400, height=600) #Opens a PNG file#
...
plot(c(0,length(days)+1), c(0, 20), type="n" , xlab ="Day", main = "Child Vocalizations During Warm Ups", cex.main=2, xaxt = "n",ylab = "Average vocalizations per 5 minute segment", cex.lab=1.3)
...
for (i in 1:length(sub_folders_paths) ){
  ...
  dayfiles=dir(pattern=paste(sub_folders[i], "_WarmUp.csv", sep = ""), full.names = FALSE)
...
#progress
plot(c(0,length(days)), c(-20,20), type="n" , main ="Vocalizations During Warm Ups Across the Week", cex.main=2, xaxt = "n", xlab=NA, ylab = "Differences in child vocalization count per 5 minutes compared to Monday", cex.lab=1.3, cex.main=2)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/child-voc-dur-WarmUp.png",width=1400, height=600)
par(mfrow=c(1,2))
...
plot(c(0,length(days)+1), c(0, 20), type="n" , xlab ="Day", main = "Child Vocalization Duration During Warm Ups", cex.main=2, xaxt = "n",ylab = "Average Vocalization Duration per 5 Minute Segment", cex.lab=1.3)
axis(side = 1,at= c(1:length(days)),labels =days,  las=1)
...
plot(c(0,length(days)), c(-20, 20), type="n" , main ="Child's Vocalization Duration Progress During Warm Ups", cex.main=2, xaxt = "n", xlab=NA,ylab = "Differences in child vocalization duration per 5 minutes compared to Monday", cex.lab=1.3, cex.main=2)
axis(side = 1,at= 1:3,labels = c( "Tue-Mon", "Wed-Mon", "Thur-Mon"),  las=1)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/child-conv-turns-WarmUp.png",width=1400, height=600)
par(mfrow=c(1,2))
...
plot(c(0,length(days)+1), c(0, 10), type="n" , xlab ="Day", main = "Conversational Turns During Warm Ups", cex.main=2, xaxt = "n",ylab = "Turns per 5 Minute Block"  , cex.lab=1.3)
axis(side = 1,at= c(1:length(days)),labels =days,  las=1)

for (i in 1:length(sub_folders_paths) ){
  setwd(paste(sub_folders_paths[i], "/Event View", sep = ""))
  dailyFile=dir(pattern="_WarmUp.csv", full.names = FALSE)
...
plot(c(0,length(days)), c(-10,10), type="n" , main ="Child's conversational turns Progress During Warm Ups", cex.main=2, xaxt = "n", xlab=NA,ylab = "Differences in conversational turns per 5 minutes compared to Monday", cex.lab=1.3, cex.main=2)
axis(side = 1,at= 1:3,labels = c( "Tue-Mon", "Wed-Mon", "Thur-Mon"),  las=1)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/child-segment-dur-WarmUp.png",width=1400, height=600)
par(mfrow=c(1,2))
...
plot(c(0,length(days)+1), c(0, 20), type="n" , xlab ="Day", main = "Segment Duration per 5 Minute Block During Warm Ups", cex.main=2, xaxt = "n",ylab = "Time (s)"  , cex.lab=1.3)
axis(side = 1,at= c(1:length(days)),labels =days,  las=1)
...
plot(c(0,length(days)), c(-20,20), type="n" , main ="Child's Segment Duration Progress During Warm Ups", cex.main=2, xaxt = "n", xlab=NA,ylab = "Differences in child segment duration per 5 minutes compared to Monday", cex.lab=1.3, cex.main=2)
axis(side = 1,at= 1:3,labels = c( "Tue-Mon", "Wed-Mon", "Thur-Mon"),  las=1)
