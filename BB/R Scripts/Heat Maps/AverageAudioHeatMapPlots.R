#LENA Data Analysis: Average Audio Level Heat Map
#Jacob Stroud
...
##1 Section PNG##
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Monday-avg-HeatMap.png",width=600, height=600) #Opens a PNG file#
...
##Plot##
plot(c(1,length(activities)), c(70, 90), type="n" , xlab ="Activity", main = "Child Segment Average dB SPL on Monday", cex.main=2, xaxt = "n",ylab = "Average dB SPL per Child Segment", cex.lab=1.3)
...
for (i in 1:length(sub_folders_paths) ){
  ...
  dayfiles=dir(pattern=paste(sub_folders[i], "_avgaudio.csv", sep = ""), full.names = FALSE)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Tuesday-avg-HeatMap.png",width=600, height=600)
...
plot(c(1,length(activities)), c(70, 90), type="n" , xlab ="Day", main = "Child Segment Average dB SPL on Tuesday", cex.main=2, xaxt = "n",ylab = "Average dB SPL per Child Segment", cex.lab=1.3)
axis(side = 1,at= c(1:length(activities)),labels =activities,  las=1)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Wednesday-avg-HeatMap.png",width=600, height=600)
...
plot(c(1,length(activities)), c(70, 90), type="n" , xlab ="Day", main = "Child Segment Average dB SPL on Wednesday", cex.main=2, xaxt = "n",ylab = "Average dB SPL per Child Segment"  , cex.lab=1.3)
axis(side = 1,at= c(1:length(activities)),labels =activities,  las=1)

for (i in 1:length(sub_folders_paths) ){
  setwd(paste(sub_folders_paths[i], "/Heat Map View", sep = ""))
  turnsAll <- na.omit(turnsAll)
  dailyFile=dir(pattern="_avgaudio.csv", full.names = FALSE)
...
png(filename ="/Volumes/data/Research/CDB/Progress Monitoring:LENA/Brave Buddies/Plots and Results/Thursday-avg-HeatMap.png",width=600, height=600)
...
plot(c(1,length(activities)), c(70, 90), type="n" , xlab ="Day", main = "Child Segment Average dB SPL On Thursday", cex.main=2, xaxt = "n",ylab = "Average dB SPL per Child Segment"  , cex.lab=1.3)
axis(side = 1,at= c(1:length(activities)),labels =activities,  las=1)
